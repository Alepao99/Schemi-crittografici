...
// and in particular try it out with arrays of length exactly a multiple of 16 bytes (16,32,48,...) to verify that padding is always done.
...
+ " bytes: " + ptLength+" "+plainText.length); 
