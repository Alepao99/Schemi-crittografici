...
public class Shamir1outof3Dealer {
	...
	public static void main( // this is the implementation of the dealer of a (1,3)-Shamir SS, that is each
								// subset of 2 participants must recover the secret but any single participant
								// does not.
		...
		BigInteger[] secretshares = new BigInteger[3]; // this is the array that will contain the shares to send to each
														// participant
