...
public class Shamir1outof3Participant implements java.io.Serializable {
	...
	public static void main( // this is the participant in the (1,3)-Shamir SS
		...
		if (args[0].equals("1")) { // the participant takes as input 1 or 0. If the input is 1 then the partcipant
									// partcipates in the reconstruction and connects to the Reconstruction Server
									// and sends it the share

			System.out.println("Secret share sent for reconstruction: " + secretshare);
			cSock = (SSLSocket) sockfact.createSocket("localhost", 4001); // connect to the Reconstruction Server that
																			// is listening on port 4001
